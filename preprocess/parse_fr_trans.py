...
filename=['./fr/frwiktionary-latest-pages-articles.xml', './fr/frwiktionary-latest-pages-meta-current.xml']
output='./fr/en_fr_dict2.csv'
outputmono = './fr/fr_dict2.csv'
start = 0
...
translate_start = set(['=={{S|traductions}}==','=={{S|traduction}}=='])
...
transtop = u'{{trad-début|'
transtop2 = '{{trad-debut|'
transbottom = '{{trad-fin'
            ...
            for ind in range(len(content)):
                ...
                if role == 0:
                    ...
                    if len(line) > len(common_end) and line[:len(common_end)] == common_end:
                        ...
                        role = 0
                        continue
                    elif ((not got_meaning) and len(line) > len(transtop) and line[:len(transtop)] == transtop) or ((not got_meaning) and len(line) > len(transtop2) and line[:len(transtop2)] == transtop2):

...
from keras.layers import Dense, Activation, Dropout, Embedding, LSTM, GRU, Bidirectional, BatchNormalization, Average
...
model.fit(train_d, train_w, batch_size=batchsize1, epochs=150)
